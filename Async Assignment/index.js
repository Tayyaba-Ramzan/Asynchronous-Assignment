...
var fetchGreeting = function () { return __awaiter(_this, void 0, void 0, function () {
...
fetchGreeting().then(function (res) {
    console.log(res);
});
...
fetchWithError().then(function (res) {
    console.log(res);
})
...
var executeSequentially = function () { return __awaiter(_this, void 0, void 0, function () {
    var fetchDataResult, processDataResult, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 3, , 4]);
